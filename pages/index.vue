<template>
  <div>
    ...
    <div slide-id="0" class="slide text-center h-screen py-32 mx-auto md:w-5/6 xl:w-2/3">
    ...
    <div slide-id="1" class="slide text-center h-screen pb-32 mx-auto md:w-5/6 xl:w-2/3">
    ...
    <div class="mx-auto w-full py-4 arrow-container">
      <div role="button" v-if="slideNumber + 1 < slideCount" class="arrow" @click="moveSlide(1)">
        <img class="mx-auto my-auto h-6" src="~/assets/arrow.svg" alt="" srcset="">
      </div>
      <div role="button" v-if="slideNumber > 0" class="arrow" @click="moveSlide(-1)">
